...
public class PlayerController_desert : MonoBehaviour
{
    ...
    public static PlayerController_desert instance;
    ...
    float[] biasLength = new float[8] { 0.5f, 0.35f, 0.25f, 0.2f, 0, 0, -0.4f, 0 };
